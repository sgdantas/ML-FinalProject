...
def load_data(dataset_str):
    ...
    for i in range(len(names)):
        with open(os.path.join(data_dir_citation, "ind.{}.{}".format(dataset_str, names[i])), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file(os.path.join(data_dir_citation, "ind.{}.test.index".format(dataset_str)))
